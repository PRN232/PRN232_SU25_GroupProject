...
namespace PRN232_SU25_GroupProject.DataAccess.Migrations
{
    ...
    [Migration("20250701094623_VaccinationConsentToMedicalConsent")]
    partial class VaccinationConsentToMedicalConsent
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PRN232_SU25_GroupProject.DataAccess.Entities.VisionHearing", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PRN232_SU25_GroupProject.DataAccess.Entities.VisionHearing", b =>
                {
                    b.HasOne("PRN232_SU25_GroupProject.DataAccess.Entities.MedicalProfile", null)
                        .WithOne("VisionHearing")
                        .HasForeignKey("PRN232_SU25_GroupProject.DataAccess.Entities.VisionHearing", "MedicalProfileId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
